...
activation_all_batch_post_request_instance = ActivationAllBatchPostRequest.from_json(json)
# print the JSON string representation of the object
print(ActivationAllBatchPostRequest.to_json())

# convert the object into a dict
activation_all_batch_post_request_dict = activation_all_batch_post_request_instance.to_dict()
# create an instance of ActivationAllBatchPostRequest from a dict
activation_all_batch_post_request_from_dict = ActivationAllBatchPostRequest.from_dict(activation_all_batch_post_request_dict)
```
