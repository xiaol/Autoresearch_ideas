...
activation_single_batch_post_request_instance = ActivationSingleBatchPostRequest.from_json(json)
# print the JSON string representation of the object
print(ActivationSingleBatchPostRequest.to_json())

# convert the object into a dict
activation_single_batch_post_request_dict = activation_single_batch_post_request_instance.to_dict()
# create an instance of ActivationSingleBatchPostRequest from a dict
activation_single_batch_post_request_from_dict = ActivationSingleBatchPostRequest.from_dict(activation_single_batch_post_request_dict)
```
