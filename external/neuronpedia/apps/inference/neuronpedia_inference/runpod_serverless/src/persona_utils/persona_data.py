...
and contrast vectors for persona analysis.
"""
...
# =============================================================================
# Scaler classes - needed for unpickling the minimal PCA data files
# =============================================================================
def _to_numpy(x):
...
# PC titles for the principal components
ROLE_PC_TITLES = [
...
class PersonaData:
    ...
    def _get_data_path(self) -> str:
        ...
        # Data files are expected at data/<model_id>/
        # Check environment variable first
        env_path = os.environ.get("PERSONA_DATA_PATH")
        if env_path:
            return env_path
