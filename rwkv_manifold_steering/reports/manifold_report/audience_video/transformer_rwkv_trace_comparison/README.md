...
- `qwen_rwkv_trace_comparison_plus20db.mp4`: final narrated MP4 with subtitles, per-beat leveled narration, and a quieter ending taper. This replaces the raw plus-20 dB remux because the uncorrected version was much louder near the end.
...
- Final audio leveling: per-tutorial-beat gain correction, limiter, and an ending taper for the closing RWKV beats.
