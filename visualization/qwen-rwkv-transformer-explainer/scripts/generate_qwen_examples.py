#!/usr/bin/env python3
"""Generate static Qwen traces for the example dropdown."""
...
from qwen_trace import DEFAULT_MODEL_ID, build_trace, load_qwen
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="static/qwen-traces")
