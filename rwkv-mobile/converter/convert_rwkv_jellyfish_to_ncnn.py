...
for i in range(n_layer):
    if version == 6:
        layer_count, blob_count = build_time_mixing_v6(ncnn_param_lines, ncnn_weights_file, weights, layer_input, f'time_mixing_{i}_out', i, layer_count, blob_count, n_head, head_size, jellyfish_modified=True, use_fp32=use_fp32)
        ...
        layer_count, blob_count = build_time_mixing_v7(ncnn_param_lines, ncnn_weights_file, weights, layer_input, f'time_mixing_{i}_out', i, layer_count, blob_count, n_head, head_size, jellyfish_modified=True, use_fp32=use_fp32)
